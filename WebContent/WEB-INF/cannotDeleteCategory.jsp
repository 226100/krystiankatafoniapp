...
<head>
<meta charset="utf-8">
<!-- Close page after 3s and redirect to category controller -->
<meta http-equiv="refresh" content="3; url=category" />
<title>Shopping List - Cannot delete category</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<!-- External imports for bootstrap, animations, jquery -->
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
<link href="http://netdna.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css" rel="stylesheet">
<script src="http://netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css">
<!-- Css styles for cannotDeleteCategory.jsp -->
					...
					<div id="pie-chart-widget " class="panel">
            			<div class="panel-heading text-center ">
            				<!-- Text message for user -->
               				<h5 class="text-uppercase  text-danger "><strong>YOU CANNOT DELETE THIS CATEGORY BECAUSE IT'S ALREADY USED IN PURCHASE</strong></h5>
